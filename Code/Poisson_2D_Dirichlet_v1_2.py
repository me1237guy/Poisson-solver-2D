...
# Boundary operators
B = I_sp        # Boundary operator for the outer walls. B = I_sp indicates that it is a Dirichlet boundary.
B2 = I_sp       # Boundary operator for the inner regions. B2 = I_sp indicates that it is a Dirichlet boundary.
...
L_sys[ind_boundary_unravel,:] = B[ind_boundary_unravel,:]    # Boundaries at the four edges
L_sys[ind_boundary2_unravel,:] = B2[ind_boundary2_unravel,:]  # Boundaries defined by xb2 and yb2 (inside boundaries)
#==============================================================================
